...
var modules = []*models.Module{
	...
	{Name: "资产扫描配置", Key: "AssetManager", Path: "/asset/config", Controller: "AssetController", Action: "Config", IsMenu: false},
	{Name: "资产扫描", Key: "AssetManager", Path: "/asset/scan", Controller: "AssetController", Action: "Scan", IsMenu: false},
	{Name: "Osquery Agent管理", Key: "OsqueryAgentManager", Path: "/osqueryagent/query", Controller: "OsqueryAgentController", Action: "Query", IsMenu: true},
	{Name: "Osquery任务管理", Key: "OsqueryTaskManager", Path: "/osquerytask/query", Controller: "OsqueryTaskController", Action: "Query", IsMenu: true},
	{Name: "添加Osquery任务", Key: "OsqueryTaskManager", Path: "/osquerytask/create", Controller: "OsqueryTaskController", Action: "Create", IsMenu: false},
	{Name: "删除Osquery任务", Key: "OsqueryTaskManager", Path: "/osquerytask/delete", Controller: "OsqueryTaskController", Action: "Delete", IsMenu: false},
	{Name: "查看Osquery任务结果", Key: "OsqueryTaskManager", Path: "/osquerytask/result", Controller: "OsqueryTaskController", Action: "Result", IsMenu: false},
